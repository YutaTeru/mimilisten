...
- アプリ本体: Cloudflare Workers `mimilisten`
...
```powershell
powershell -ExecutionPolicy Bypass -File tools\deploy-worker-to-cloudflare.ps1
```
...
- アプリ: https://mimilisten.itisnowornever271.workers.dev/
- 旧Pages確認用: https://mimilisten.pages.dev/
